...
class PlayerManager(Manager):
    ...
    def __init__(self, name, x, y):
        ...
        self.add_renderable(Button("Test1", text="TESTING", width=100, height=100, x=110, y=0 ,on_click=lambda game, system: print("hello")))
        self.add_renderable(Button("Test2", text="TESTING", width=100, height=100, x=220, y=0 ,on_click=lambda game, system: print("hello")))
        self.add_renderable(Button("Test3", text="TESTING", width=100, height=100, x=330, y=0 ,on_click=lambda game, system: print("hello")))
